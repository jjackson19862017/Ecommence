...
@section('content')
    ...
    @php
        ...
        $featured = DB::table('products')->whereStatus(1)->orderBy('id','desc')->limit(8)->get();
    $trend = DB::table('products')->whereStatus(1)->whereTrend(1)->orderBy('id','desc')->limit(8)->get();
    $best = DB::table('products')->whereStatus(1)->whereBestRated(1)->orderBy('id','desc')->limit(8)->get();
$hot = DB::table('products')
->join('brands','products.brand_id','brands.id')
->select('products.*','brands.brand_name')
->whereStatus(1)->whereHotDeal(1)->limit(3)->get();
